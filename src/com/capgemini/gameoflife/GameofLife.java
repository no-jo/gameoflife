/**
 * Class responsible for the logic of game of life and determining the state for board for next turn.
 */
...
public class GameofLife {
	...
	/**
	 * Sole class constructor, requires initialized board to create GameofLife object. 
	 * @param board
	 */
	...
	/**
	 * Triggers evaluation of the board state and overwrites new dead or alive states. 
	 */
	public void runTurn() {
	...
	/** 
	 * Returns the current state of the board as two dimensional Integer array.
	 */
	...
	private Boolean should_square_live(int rowPos, int colPos) {
		...
		if (live_neighbors_counter == 3 || (live_neighbors_counter == 2 && board[rowPos][colPos] == 1))
			return true;
		else
			return false;
	}
